 ...
 */
    ...
    public:
        ...
        void spawnCube(const std::string& name,const std::string& color, const std::string& frame_id,
         ...
         */
        void spawnPrimitive(const std::string& name,const std::string& color, const bool isCube,
